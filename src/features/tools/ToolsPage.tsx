...
const tools = [
	{
		...
		description:
			'Compare AHUs, Chillers, Cooling Towers, Custom Equipment, and more for MEP design.',
	...
	},
	{
		...
		description:
			'Upload, organize, and share project photos for documentation and collaboration.',
			...
			<div className="max-w-4xl mx-auto px-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					{tools.map((tool) => (
						<button
							key={tool.name}
							className="bernoullia-card p-6 flex flex-col gap-3 hover:scale-[1.02] transition-transform text-left bg-transparent border-none cursor-pointer"
						...
						>
							...
							<span className="mt-auto text-blue-400 hover:underline">
								Open Tool →
							</span>
						</button>
					))}
