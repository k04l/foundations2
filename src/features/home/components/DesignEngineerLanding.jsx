...
export const DesignEngineerLanding = () => {
  ...
  // State for projects and equipment
  ...
  const addEquipment = () => {
    ...
    setEquipmentOptions(prev => [...prev, newEquipment]);
  };
  ...
  const deleteEquipment = (id) => {
    setEquipmentOptions(prev => prev.filter(option => option.id !== id));
...
----------------------------------------
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-blue-100 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-gray-800/50 backdrop-blur-md border-r border-blue-500/20 p-6 flex-shrink-0">
        ...
        {selectedProject && (
          <button
            ...
            className="mt-2 w-full flex items-center justify-center px-4 py-2 bg-gray-700 text-blue-100 rounded-lg hover:bg-gray-600 transition-colors"
          >
            <Plus className="mr-2" size={16} /> Add Equipment
          </button>
        )}
      </aside>
                ...
                <>
                  ...
                  {selectedOption && (
                    <div className="bg-gray-900 p-6 rounded-lg border border-blue-500/20">
                      <h4 className="text-xl font-semibold text-blue-100 mb-4">
