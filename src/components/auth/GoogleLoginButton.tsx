...
interface GoogleLoginButtonProps {
  // Optionally accept props for customization
}
...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = () => (
  <button
    ...
    className="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-gray-700 font-medium hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mb-4"
  >
